...
-- ----------------------------
BEGIN;
INSERT INTO `system_menu` VALUES (1, '常规管理', -1, 'menuHeader1', 'fa fa-address-book', 0, '_self', 'ce23f05b9ba8f06dedc139abeae5b2e8', 3, 0, 0);
...
INSERT INTO `system_menu` VALUES (25, '后台管理员', 7, 'systemUser/page', 'fa fa fa fa-slideshare', 2, '_self', 'ea55064a6a4c5ff8521d1d95225bd64a', 10, 1, 0);
...
INSERT INTO `system_menu` VALUES (68, '相关个股', 66, '', 'fa fa-address-book', 2, '_self', '14401fdf279ed08b55d8b2b6f73e2812', 83, 1, 0);
...
INSERT INTO `system_menu` VALUES (70, '交易统计', 71, '/statis/trade/page', 'fa fa fa-area-chart', 2, '_self', '162f4617944995e7b6692683946966cb', 99, 0, 0);

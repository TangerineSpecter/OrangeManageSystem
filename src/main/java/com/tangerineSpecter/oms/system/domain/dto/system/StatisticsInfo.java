...
public class StatisticsInfo implements Serializable {
    ...
    private void calIncome(List<RecordCalStatisDto> calStatisDto) {
        ...
        this.lastThirtyDate = CollUtils.convertReverseLimitList(calStatisDto, RecordCalStatisDto::getDate, 30);
        this.lastThirtyTotalMoney = CollUtils.convertReverseLimitList(calStatisDto, RecordCalStatisDto::getTotalEndMoney, 30);
    }

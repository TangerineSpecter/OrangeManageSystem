...
public class RetCode {
	...
	public static final String REGISTER_REPEAT_DESC = "该帐号已注册，请重新申请！";

	/**
	 * 帐号密码错误
	 */
	public static final Integer ACCOUNTS_PASSWORD_ERROR_CODE = 101;
	public static final String ACCOUNTS_PASSWORD_ERROR_DESC = "帐号密码输入有误，请重新确认后登录！";

	/**
	 * 帐号不存在
	 */
	public static final Integer ACCOUNTS_NOT_EXSIT_CODE = 102;
	public static final String ACCOUNTS_NOT_EXSIT_DESC = "您输入的帐号不存在，请注册后重新登录！";
}
